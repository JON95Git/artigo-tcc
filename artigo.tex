...
\textit{Resumo -} \normalfont{\textit{Este artigo apresenta uma alternativa de desenvolvimento de
firmware robusto e multiplataforma, com o intuito de minimizar bugs de software, permitir a implementação
de testes unitários e incentivar o estudo de conceitos de Engenharia de software aplicados a sistemas embarcados.}}
\end {abstract}
...
\noindent\begin{abstract}
\textit{Abstract - } \normalfont{\textit{This article presents an alternative for the development of
robust and multiplatform firmware, in order to minimize software bugs, allow the implementation of unit
tests and encourage the study of software engineering concepts applied to embedded systems.}}
\end {abstract}
\noindent\begin{keywords}
